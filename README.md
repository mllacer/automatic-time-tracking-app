...
Time Tracking App is a Windows background utility that listens for workstation lock, unlock, suspend, resume, logoff, and shutdown events, stores the raw event stream in SQLite, and exports computed work sessions to yearly Excel workbooks.
